...
class CausalSelfAttention(nn.Module):
    ...
    def forward(self, x):
        ...
        # ==================== Process Q ====================
        compressed_q = self.q_a_layernorm(self.q_a_proj(x))
        ...
        for i, latent in enumerate(kv_latents):
            normed_kv_latents.append(self.kv_a_layernorms[i](latent))
        ...
        y_a = flash_attn_func(q=q_new, k=k_a, v=v_a, causal=True)
        y_b = flash_attn_func(q=q_new, k=k_b, v=v_b, causal=True)
        y = y_a + y_b
