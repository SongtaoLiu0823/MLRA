...
model_args = dict(n_layer=n_layer, n_head=n_head, n_embd=n_embd, intermediate_size=intermediate_size, 
                  block_size=block_size, bias=bias, q_lora_rank=q_lora_rank, qk_rope_head_dim=qk_rope_head_dim, 
                  kv_lora_rank=kv_lora_rank, qk_nope_head_dim=qk_nope_head_dim, vocab_size=None, dropout=dropout) # start with model_args from command line
