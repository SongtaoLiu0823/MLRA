...
class CausalSelfAttention(nn.Module):
    def __init__(self, config):
        ...
        self.c_gated = nn.Linear(self.n_embd, self.head_dim * self.n_head, bias=False)
    ...
    def reset_parameters(self):
        nn.init.normal_(self.c_gated.weight, mean=0.0, std=0.02)
    ...
    def forward(self, x):
        ...
        gated_score = F.sigmoid(self.c_gated(x))
